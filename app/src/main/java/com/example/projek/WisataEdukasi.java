...
public class WisataEdukasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Kebun Binatang Lembah Hijau","Perpustakaan Modern Provinsi Lampung","Lembah Naga Kedaung","Kebun Edukasi Kalianda", "Taman Budaya Provinsi Lampung","Museum Lampung","Taman Edukasi Umbul Musa"
